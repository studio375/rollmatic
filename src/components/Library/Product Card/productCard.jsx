...
export default function ProductCard({prodObject, ...props}){
    ...
    return <div {...props} className={`card w-[calc(100%/3)] max-m:w-1/2 max-xs:w-full relative flex ${props.className} it-id-${prodObject.cat.main_cat_italian_id} [&:not(.it-id-284)]:min-[1920px]:!w-[calc(100%/4)]`}>
