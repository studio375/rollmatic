...
export default function Timeline({page, ...props}){
    ...
    useEffect(() => {
        ...
        tml2.to(lineRef.current, {height:"100%", ease: 'none'});
    ...
    return <section {...props} className={`w-full relative big-boxed my-15 max-m:mt-10 max-xs:mt-5 ${props.className || ''}`}>
        <div ref={lineRef} className="w-[1px] h-0 bg-[var(--color-primary)] absolute top-0 left-1/2 max-s:left-[5vw] max-s:top-6"></div>
