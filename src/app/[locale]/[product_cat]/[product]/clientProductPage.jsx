...
export default function ProductPage({prodotto, cat=[...cat], formObject = null}){
    ...
    return <>
        ...
        {
            foto_emotional && foto_emotional.length > 0 && <section className="px-[75px] max-xl:px-3 mb-10 mt-5 max-s:mb-7"><VideoCarousel videoIds={null} images={foto_emotional} /></section>
        }
