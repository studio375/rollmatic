...
export default async function Page({params}){
    ...
    return <>
        <section className="mt-20 big-boxed flex items-start">
            <div className="flex flex-col items-start [&_*]:!text-[24px]/[30px] w-[calc(100%/3)]">
                <h1 className="!text-[24px]/[30px] font-bold !text-[var(--color-foreground)]">{parse(page.acf.titolo)}</h1>
                <span className="block mt-1">{parse(page.acf.indirizzo)}</span>
